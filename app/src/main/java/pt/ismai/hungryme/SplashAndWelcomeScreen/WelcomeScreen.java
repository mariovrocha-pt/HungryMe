...
public class WelcomeScreen extends AppCompatActivity {
    ...
    private class ScreenSlideAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            WelcomeFragments welcomeScreenFragment = null;
            switch (position) {
                case 0:
                    welcomeScreenFragment = WelcomeFragments.newInstance(R.layout.fragment_screen1);
                    break;
                case 1:
                    welcomeScreenFragment = WelcomeFragments.newInstance(R.layout.fragment_screen2);
                    break;
                case 2:
                    welcomeScreenFragment = WelcomeFragments.newInstance(R.layout.fragment_screen3);
                    break;
                case 3:
                    welcomeScreenFragment = WelcomeFragments.newInstance(R.layout.fragment_screen4);
                    break;
            }
